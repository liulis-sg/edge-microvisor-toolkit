...
Source0:        https://github.com/intel/mainline-tracking/archive/refs/tags/mainline-tracking-pre-prod-v6.17.11-linux-251224T042908Z.tar.gz
...
%prep
%setup -q -n mainline-tracking-mainline-tracking-pre-prod-v6.17.11-linux-251224T042908Z
...
rm -fr usr/include/headers_check.pl
...
%changelog
* Fri Jan 2 2026 Lishan Liu <lishan.liu@intel.com> - 6.17.11-1
- Update kernel to mainline-tracking-pre-prod-v6.17.11-linux-251224T042908Z
...
* Mon Dec 30 2024 Anuj Mittal <anuj.mittal@intel.com> - 6.6.66-6
- Bump to sync with kernel

* Mon Dec 30 2024 Anuj Mittal <anuj.mittal@intel.com> - 6.6.66-5
- Bump to sync with kernel

* Fri Dec 27 2024 Anuj Mittal <anuj.mittal@intel.com> - 6.6.66-4
- Bump release to sync with kernel
...
* Tue Nov 26 2024 Anuj Mittal <anuj.mittal@intel.com> - 6.6.62-2
- Update to 6.6.62-2

* Fri Nov 22 2024 Ren Jiaojiao <jiaojiaox.ren@intel.com> - 6.6.62-1
- Upgrade to version 6.6.62-1

* Tue Oct 15 2024 Ren Jiaojiao <jiaojiaox.ren@intel.com> - 6.6.53-1
- Upgrade to version 6.6.53-1

* Thu Sep 26 2024 Ren Jiaojiao <jiaojiaox.ren@intel.com> - 6.6.52-1
- Upgrade to version 6.6.52-1

* Mon Sep 23 2024 Shi Qingdong <qingdong.shi@intel.com> - 6.6.49-1
- Upgrade to version 6.6.49-1

* Fri Sep 06 2024 Shi Qingdong <qingdong.shi@intel.com> - 6.6.48-1
- Upgrade to version 6.6.48-1

* Tue Aug 06 2024 Zhou Furong <furong.zhou@intel.com> - 6.6.43-1
- Upgrade to version 6.6.43-1

* Tue Jul 09 2024 Zhou Furong <furong.zhou@intel.com> - 6.6.35-1
- Update kernel config for Edge Microvisor Toolkit.
