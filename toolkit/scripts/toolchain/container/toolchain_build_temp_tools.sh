...
tar xf mainline-tracking-pre-prod-v6.17.11-linux-251224T042908Z.tar.gz
pushd mainline-tracking-mainline-tracking-pre-prod-v6.17.11-linux-251224T042908Z
make mrproper
make headers
...
popd
rm -rf lts-v${KERNEL_VERSION}-edge-250324T192946Z
